            ...
            return (
              ...
              (u || t in i) &&
                (n =
                  n.replace(
                    c,
                    o ? e.map(m.default).join("/") : (0, m.default)(e)
                  ) || "/")
            );
          }) || (n = ""),
          { params: u, result: n }
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 22:
                              if (
                                ...
                                (g = (m = d).pathname),
                                (b = m.query),
                                (d = this._resolveHref(d, s)).pathname !== g &&
                                  ((g = d.pathname),
                                  (n = (0, h.formatWithValidation)(d))),
                                (g = g
                                  ? (0, c.removePathTrailingSlash)(P(g))
                                  : g),
                                this.urlIsNew(u) || (r = "replaceState"),
                                (S = (0, c.removePathTrailingSlash)(g)),
                                (E = i.shallow),
                                (O = void 0 !== E && E),
                            ...
                            case 65:
                              return (
                                ...
                                (e.next = 70),
                                this.set(S, g, b, u, W).catch(function (t) {
